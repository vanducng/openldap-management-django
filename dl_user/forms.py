    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Fieldset('Basic Data',
                     ...
                     Field('last_name', placeholder="Nguyen"),
                     Field('email', placeholder='duc.nv2@homecredit.vn')),
            Fieldset('Login Details',
                     Field('username', placeholder='duc.nguyenv3'),
                     'password',
                     'password1'),
        )
        if "Personal Data" in settings.LDAP_USER_DATA:
            self.helper.layout.append(
                Fieldset('Personal Data',
                         'gender', 'title',
                         Field('designation', placeholder='Data Engineer'),
                         Field('department', placeholder='IT'),
                         Field('phone', placeholder='0905123456')))
        if "Organization" in settings.LDAP_USER_DATA:
            self.helper.layout.append(
